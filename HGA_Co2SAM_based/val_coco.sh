...
# ============================================================
# val_coco.bash - Co2SAM single-scaled validation/test (COCO 2014)
# usage: bash val_coco.bash
...
if [ -n "$CRF" ]; then
    CRF_PID=""
    IMAGES_DIR="path/to/your/MSCOCO/JPEGImages/val"
    GT_DIR="path/to/your/MSCOCO/SegmentationClass/val"
    N_CLASS=81
    N_JOBS=50
...
echo "=========================================="
echo "validating: python val_coco.py ${ARGS[@]}"
echo "=========================================="

python val_coco.py "${ARGS[@]}"
